...
Next, to scale up GCCA to large datasets, we first form a rank-$m$ approximation of projection matrices as in~\cite{arora2012kernel} and then extend it to an eigendecomposition for $M$ following ideas from~\cite{savostyanov}. 
...
\begin{table*}[ht]
  ...
  \begin{tabular}{+l |                 +d{2.1}     +d{2.1}     +d{2.1}  |   +d{2.1}     +d{2.1}       +d{2.1}       |   +d{2.1}       +d{2.1}|| +c                                  +c |     +c            +c }
    \mm{Test Set}                  & \m{Glove} & \m{WSG}   & \mm{G-WSG} & \m{MVLSA} & \m{MVLSA}     & \mm{MV-G-WSG} & \m{MV}    & \mmm{G-WSG} & \multicolumn{2}{c|}{$r_s$ MVLSA} & \multicolumn{2}{c}{$r_s$ MV-G-WSG} \\
                \mm{}              & \m{}      & \m{}      & \mm{Combo} & \m{Wiki } & \m{All Views} & \mm{Combined} & \m{Gain}  & \mmm{Gain } & \m{Glove}                        & \mm{WSG} & \m{Glove} & \m{WSG}     \\\hline
MEN                                & 70.4      & 73.9      & \myy{76.0} & 71.4      & 71.2          & \myy{75.8}    & -0.2      & \ma{4.6}   & 71.9                             & 89.1     & 85.8      & 92.3        \\
...
WS                                 & 58.6      & \my{70.8} & \myy{67.4} & \y{68.0}  & \my{70.8}     & \myy{70.1}    & \ma{2.8}  & -0.7       & 72.3                             & 88.1     & 81.8      & 91.8        \\
MTURK                              & \y{61.7}  & \my{65.1} & 59.8       & 59.1      & 59.7          & \myy{62.9}    & 0.6       & 3.2        & 80.0                             & 87.7     & 87.3      & 92.5        \\
WS-REL                             & 53.4      & \my{63.6} & 59.6       & 60.1      & \y{65.1}      & \myy{63.5}    & \ma{5.0}  & -1.6       & 58.2                             & 81.0     & 69.6      & 85.3        \\
WS-SEM                             & 69.0      & \y{78.4}  & \myy{76.1} & \y{76.8}  & \y{78.8}      & \myy{79.2}    & 2.0       & 0.4        & 74.4                             & 90.6     & 83.9      & 94.0        \\
\rowstyle{\color{darkergray}}RG    & \y{73.8}  & \y{78.2}  & \myy{80.4} & 71.2      & \y{74.4}      & \myy{80.8}    & 3.2       & \ma{6.4}   & 80.3                             & 90.6     & 91.8      & 92.9        \\
\rowstyle{\color{darkergray}}MC    & \y{70.5}  & \y{78.5}  & \myy{82.7} & \y{76.6}  & \y{75.9}      & \myy{77.7}    & -0.7      & 2.8        & 80.1                             & 94.1     & 91.4      & 95.8        \\
T-SYN                              & 61.8      & 59.8      & 51.0       & 42.7      & 60.0          & \myy{64.3}    & \ma{17.3} & \ma{4.3}   &                                  &          &           &             \\
T-SEM                              & \my{80.9} & 73.7      & 73.5       & 36.2      & 38.6          & 77.2          & \ma{2.4}  & \ma{38.6}  &                                  &          &           &             \\
\rowstyle{\color{darkergray}}TOEFL & \y{83.8}  & 81.2      & \myy{86.2} & 78.8      & \y{87.5}      & \myy{88.8}    & \ma{8.7}  & 1.3        &                                  &          &           & 
  \end{tabular}
