...
% CCA based techniques 
and have recently been applied to 
learning word embedding~\cite{dhillon2011multi,dhillon2012two,faruqui2014improving} . % Note that CCA is a special case of \emph{MAX-VAR GCCA}, see \cite{velden2011on} for proof.
