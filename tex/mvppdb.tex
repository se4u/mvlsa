...
\begin{table*}[ht]
  ...
  \begin{tabular}{+l |                 +d{2.1}     +d{2.1}     +d{2.1}  |   +d{2.1}     +d{2.1}       +d{2.1}     |   +d{2.1}       +d{2.1}  | +c                                  +c |     +c            +c }
    \mm{Test Set}                  & \m{Glove} & \m{WSG}   & \mm{G-WSG} & \m{MVLSA} & \m{MVLSA}     & \mm{MV-G-WSG} & \m{MV}    & \mm{G-WSG} & \multicolumn{2}{c|}{$r_s$ MVLSA} & \multicolumn{2}{c}{$r_s$ MV-G-WSG} \\
                \mm{}              & \m{}      & \m{}      & \mm{Combo} & \m{Wiki } & \m{All Views} & \mm{Combined} & \m{Gain}  & \mm{Gain } & \m{Glove}                        & \mm{WSG} & \m{Glove} & \m{WSG}     \\\hline
...
\rowstyle{\color{darkergray}}TOEFL & \y{83.8}  & 81.2      & \myy{86.2} & 78.8      & \y{87.5}      & \myy{88.8}    & \ma{8.7}  & 1.3        &                                  &          &           & 
  ...
  \caption{Comparison of Multiview LSA against Glove and WSG(Word2Vec
   ...
   \emph{Gain} columns. $r_s$ columns demonstrate that performing GCCA
