%% **REVISION THAT WE WILL MAKE TO THE PAPER ON THE BASIS OF FEEDBACK**
%% - Add example/diagram of the views to clear up the exposition.
%% - Correct the attribution of Neural Networks from Mikolov 2013a to
%% Mikolov,
%% Yih and Zweig.
%% - Add a note to be more clear on the differences between our
%% motivation and
%% the original authors of LSA to ensure there's no confusion in context
%% of
%% that prior work.
%% - Release our matlab implementation with the paper, so that it is easy
%% to
%% replicate our work and to use this method on other datasets.
%% - Expand our overview of Multi-View learning in the background
%% section.
%% - Make the subsection on MRDS more clear and provide a more
%% verbose/friendly
%% definition.
%% - Comment on our testing methodology and the lack of standard test/dev
%% splits more explicitly.
...
\newcite{anandkumar2014tensor} who showed that at least three views
...
\begin{table*}[ht]
  ...
  \resizebox{\textwidth}{!}{
  \begin{tabular}{+l |                N          N        +d{2.1}     +d{2.1}     +d{2.1}    | N             N        +d{2.1}     +d{2.1}       +d{2.1}       |   +d{2.1}       +d{2.1}|| +c                                  +c |     +c            +c }
    \mm{Test Set}                  & Glove   & Glove    & \m{Glove} & \m{WSG}   & \mm{G-WSG} & MVLSA   & MVLSA    & \m{MVLSA} & \m{MVLSA}     & \mm{MV-G-WSG} & \m{MV}    & \mmm{G-WSG} & \multicolumn{2}{c|}{$r_s$ MVLSA} & \multicolumn{2}{c}{$r_s$ MV-G-WSG} \\
                \mm{}              & x-max=1 & sym-view & \m{}      & \m{}      & \mm{Combo} & Logproc & Reci-Wgt & \m{Wiki } & \m{All Views} & \mm{Combined} & \m{Gain}  & \mmm{Gain } & \m{Glove}                        & \mm{WSG} & \m{Glove} & \m{WSG}     \\\hline
MEN                                & 71.2    & 71.2     & 70.4      & 73.9      & \myy{76.0} & 65.9    & 67.3     & 71.4      & 71.2          & \myy{75.8}    & -0.2      & \ma{4.6}    & 71.9                             & 89.1     & 85.8      & 92.3        \\
RW                                 & 31.9    & 29.7     & 28.1      & 32.9      & 37.2       & 22.6    & 29.4     & 29.0      & \my{41.7}     & \myy{40.5}    & \ma{12.7} & -1.2        & 72.3                             & 74.2     & 80.2      & 75.6        \\
SCWS                               & 54.9    & 54.4     & 54.1      & 65.6      & 60.7       & 56.9    & 62.1     & 61.8      & \my{67.3}     & \myy{66.4}    & \ma{5.5}  & -0.9        & 87.1                             & 94.5     & 91.3      & 96.3        \\
SIMLEX                             & 32.9    & 32.9     & 33.7      & 36.7      & 41.1       & 29.7    & 41.1     & 34.5      & \y{42.4}      & \myy{43.9}    & \ma{7.9}  & 1.5         & 62.4                             & 78.2     & 79.3      & 86.0        \\
WS                                 & 61.0    & 59.1     & 58.6      & \my{70.8} & \myy{67.4} & 68.0    & 63.0     & \y{68.0}  & \my{70.8}     & \myy{70.1}    & \ma{2.8}  & -0.7        & 72.3                             & 88.1     & 81.8      & 91.8        \\
MTURK                              & 62.8    & 62.4     & \y{61.7}  & \my{65.1} & 59.8       & 50.5    & 53.0     & 59.1      & 59.7          & \myy{62.9}    & 0.6       & 3.2         & 80.0                             & 87.7     & 87.3      & 92.5        \\
WS-REL                             & 54.2    & 53.7     & 53.4      & \my{63.6} & 59.6       & 62.8    & 52.9     & 60.1      & \y{65.1}      & \myy{63.5}    & \ma{5.0}  & -1.6        & 58.2                             & 81.0     & 69.6      & 85.3        \\
WS-SEM                             & 71.5    & 68.1     & 69.0      & \y{78.4}  & \myy{76.1} & 72.3    & 74.0     & \y{76.8}  & \y{78.8}      & \myy{79.2}    & 2.0       & 0.4         & 74.4                             & 90.6     & 83.9      & 94.0        \\
\rowstyle{\color{darkergray}}RG    & 73.5    & 73.8     & \y{73.8}  & \y{78.2}  & \myy{80.4} & 64.8    & 73.2     & 71.2      & \y{74.4}      & \myy{80.8}    & 3.2       & \ma{6.4}    & 80.3                             & 90.6     & 91.8      & 92.9        \\
\rowstyle{\color{darkergray}}MC    & 73.7    & 67.7     & \y{70.5}  & \y{78.5}  & \myy{82.7} & 66.0    & 82.2     & \y{76.6}  & \y{75.9}      & \myy{77.7}    & -0.7      & 2.8         & 80.1                             & 94.1     & 91.4      & 95.8        \\
T-SYN                              & 60.7    & 61.3     & 61.8      & 59.8      & 51.0       & 31.8    & 32.7     & 42.7      & 60.0          & \myy{64.3}    & \ma{17.3} & \ma{4.3}    &                                  &          &           &             \\
T-SEM                              & 66.7    & 81.1     & \my{80.9} & 73.7      & 73.5       & 24.1    & 11.2     & 36.2      & 38.6          & 77.2          & \ma{2.4}  & \ma{38.6}   &                                  &          &           &             \\
\rowstyle{\color{darkergray}}TOEFL &         &          & \y{83.8}  & 81.2      & \myy{86.2} & 70.0    & 81.2     & 78.8      & \y{87.5}      & \myy{88.8}    & \ma{8.7}  & 1.3         &                                  &          &           & 
  \end{tabular}}
