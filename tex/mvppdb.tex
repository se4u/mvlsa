...
\begin{table*}[ht]
  ...
  \begin{tabular}{+l |                 +d{2.1}     +d{2.1} |    +d{2.1}     +d{2.1}     +d{2.1}       +d{2.1}       |   +d{2.1}       +d{2.1}|| +c                                  +c |     +c            +c }
    \mm{Test Set}                  & \m{Glove} & \mm{WSG}   & \m{G-WSG} & \m{MVLSA} & \m{MVLSA}     & \mm{MV-G-WSG} & \m{MV}    & \mmm{G-WSG} & \multicolumn{2}{c|}{$r_s$ MVLSA} & \multicolumn{2}{c}{$r_s$ MV-G-WSG} \\
                \mm{}              & \m{}      & \mm{}      & \m{Combo} & \m{Wiki } & \m{All Views} & \mm{Combined} & \m{Gain}  & \mmm{Gain } & \m{Glove}                        & \mm{WSG} & \m{Glove} & \m{WSG}     \\\hline
