...
could not be significant for the WordSimilarity test set released by
...
\emph{Minimum Required Difference for Significance (MRDS)} value for a
dataset which can be used to rule out insignificant differences. We
also hope that the following discussion would discourage the usage of the smaller
datasets.

\noindent\textbf{Minimum Required Difference (MRDS)}:
...
the following:
{\small $$ (\hat{\theta}_{B} - \hat{\theta}_{A})<\sigma_{p_0}
...
$\beta(1,1)$ to solve the following:\footnote{instead of using  McNemar's test
  \cite{mcnemar1947note} since the bayesian approach is tractable and seems more direct.}
{\small $\min\{\sigma_{p_0} |\forall\,
  0{<}\theta{<}1{-}\sigma_{p_0}\,$
  $\text{p}(\theta_{B}{\le} \theta_{A}| \hat{\theta}_A{=}\theta,
\hat{\theta}_B{=}\theta+\sigma_{p_0}, n) > p_0\}$}
...
combined by using the same method. Finally we constrast the spearman
...
\begin{table*}[ht]
  ...
  \begin{tabular}{=l| +c +c +c | +c +c +r +c +r | +c +c | +c +c }
    Test Set & Glove & WSG & G-WSG & MVLSA & MVLSA     & MV   & MV-G-WSG & G-WSG & \multicolumn{2}{c}{$r_s$ MVLSA} & \multicolumn{2}{c}{$r_s$ MV-G-WSG} \\
             &       &     & Combo & Wiki  & All Views & Gain & Combined & Gain  & Glove        & WSG         & Glove       & WSG         \\
    \hline
    
MEN                                & 70.4       & 73.9       & \myu{76.0} & 71.4       & 71.2       & -0.2      & \myu{75.8} & \ma{4.6}  & 71.9 & 89.1 & 85.8 & 92.3 \\
RW                                 & 28.1       & 32.9       & 37.2       & 29.0       & \myu{41.7} & \ma{12.7} & \myu{40.5} & -1.2      & 72.3 & 74.2 & 80.2 & 75.6 \\
SCWS                               & 54.1       & 65.6       & 60.7       & 61.8       & \myu{67.3} & \ma{5.5}  & \myu{66.4} & -0.9      & 87.1 & 94.5 & 91.3 & 96.3 \\
SIMLEX                             & 33.7       & 36.7       & 41.1       & 34.5       & \myu{42.4} & \ma{7.9}  & \myu{43.9} & 1.5       & 62.4 & 78.2 & 79.3 & 86.0 \\
WS                                 & 58.6       & \myu{70.8} & \myu{67.4} & \myu{68.0} & \myu{70.8} & \ma{2.8}  & \myu{70.1} & -0.7      & 72.3 & 88.1 & 81.8 & 91.8 \\
MTURK                              & \myu{61.7} & \myu{65.1} & 59.8       & 59.1       & 59.7       & 0.6       & \myu{62.9} & 3.2       & 80.0 & 87.7 & 87.3 & 92.5 \\
WS-REL                             & 53.4       & \myu{63.6} & 59.6       & 60.1       & \myu{65.1} & \ma{5.0}  & \myu{63.5} & -1.6      & 58.2 & 81.0 & 69.6 & 85.3 \\
WS-SEM                             & 69.0       & \myu{78.4} & \myu{76.1} & \myu{76.8} & \myu{78.8} & 2.0       & \myu{79.2} & 0.4       & 74.4 & 90.6 & 83.9 & 94.0 \\
\rowstyle{\color{darkergray}}RG    & \myu{73.8} & \myu{78.2} & \myu{80.4} & 71.2       & \myu{74.4} & 3.2       & \myu{80.8} & \ma{6.4}  & 80.3 & 90.6 & 91.8 & 92.9 \\
\rowstyle{\color{darkergray}}MC    & \myu{70.5} & \myu{78.5} & \myu{82.7} & \myu{76.6} & \myu{75.9} & -0.7      & \myu{77.7} & 2.8       & 80.1 & 94.1 & 91.4 & 95.8 \\
T-SYN                              & 61.8       & 59.8       & 51.0       & 42.7       & 60.0       & \ma{17.3} & \myu{64.3} & \ma{4.3}  &      &      &      &      \\
T-SEM                              & \myu{80.9} & 73.7       & 73.5       & 36.2       & 38.6       & \ma{2.4}  & 77.2       & \ma{38.6} &      &      &      &      \\
\rowstyle{\color{darkergray}}TOEFL & \myu{83.8} & 81.2       & \myu{86.2} & 78.8       & \myu{87.5} & \ma{8.7}  & \myu{88.8} & 1.3       &      &      &      & 
  \end{tabular}
  \caption{Comparison of Multiview LSA against Glove and WSG(Word2Vec
    Skip Gram) algorithms. We use $\sigma_{0.05}^{0.9}$ as the
...
comprehensive set of test datasets. In order to
 perform GCCA over vocabularies with upto 500K words
...
removes the need for heuristically combining word-word coccurrence 
...
to filter out non-significant comparative gains between competing
algorithms.
