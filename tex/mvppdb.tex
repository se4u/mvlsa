...
\begin{table*}[ht] \label{tab:testlist}
  ...
  \begin{tabular}{lr  cc  HH  HH  cc  l}
    Acronym & Size  &
    \specialcell{LC\\(0.01,0.5)} & \specialcell{LC\\(0.01,0.9)} &
    \specialcell{LC\\(1e-3,0.5)} & \specialcell{LC\\(1e-3,0.9)} &
    \specialcell{LC\\(0.25,0.7)} & \specialcell{LC\\(0.25,0.5)} &
    \specialcell{LC\\(0.05,0.5)} & \specialcell{LC\\(0.05,0.9)} &
    Reference  \\ 
    \hline
...
\newcite{steiger1980tests} proposed a test for
...
%% does the performance of MVLSA compare with other methods?
