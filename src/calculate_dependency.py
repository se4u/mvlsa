...
def should_include(v, dep_excl_incl, vcode):
    ...
    if dep_excl_incl[0]=="E":
        ...
        return not (sign_to_look_for+vcode in dep_excl_incl)
    else:
        return (sign_to_look_for+vcode in dep_excl_incl)
...
# /export/a14/prastog3/v5_indisvd_bitext~svd~ar~mc~CountPow012-truncatele200~100.mat
# /export/a14/prastog3/v5_indisvd_bvgn_svd_embedding_mc_CountPow012-truncatele200_100.mat
# /export/a14/prastog3/v5_indisvd_monotext10_svd_en_mc_CountPow025-truncatele200_100.mat
