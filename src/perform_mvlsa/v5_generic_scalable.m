function [G, S_tilde, sort_idx]=v5_generic_scalable(final_embedding_size, deptoload, ...
...
%% Now perform Incremental PCA by loading the data
%% This part only needs G and S_tilde
